...
<div id="div_healthPalazzetti">
    <div class="clearfix" style="margin-bottom:10px;">
        ...
        <span class="label label-danger" style="font-size:1em;"><?php echo (int) $offline; ?> {{Hors ligne}}</span>
